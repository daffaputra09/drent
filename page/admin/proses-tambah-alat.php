...
$query = "INSERT INTO tb_alat SET nama_alat = '$nama_alat' , harga_alat = '$harga_alat', stok_alat = '$stok_alat' , kategori = '$kategori' , gambar_alat1 = '$foto1' , gambar_alat2 = '$foto2' , ket1 = '$ket1', ket2 = '$ket2', ket3 = '$ket3', ket4 = '$ket4', ket5 = '$ket5', ket6 = '$ket6', ket7 = '$ket7',spek1 ='$spek1',spek2 ='$spek2',spek3 ='$spek3',spek4 ='$spek4',spek5 ='$spek5',spek6 ='$spek6',spek7 ='$spek7' ";
