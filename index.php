...
<html lang="en">
  ...
  <ul>
    ...
    <li><a href="page/guest/wishlist.php">Wishlist</a></li>
    <li><a href="page/guest/nota.php">Nota</a></li>
    <li><a href="page/guest/profil.php">Profil</a></li>
  </ul>
  <div class="search">
    ...
    <div class="container">
      <div class="kategori">
        ...
        <?php
              ...
              ?>
          <li class="card">
            <a class="card-image" href="page/guest/kategori.php?kategori=<?php echo $data['kategori'];?>">
              <img src="images_upload/<?php echo $data['gambar_kategori'];?>" alt="" />
            </a>
            <a class="card-description" href="page/guest/kategori.php?kategori=<?php echo $data['kategori'];?>">
    ...
    <footer class="footer">
      ...
      <div class="footer-center">
        <ul>
          ...
          <li>
            <a href="page/guest/wishlist.php">Wishlist</a>
          </li>
          <li>
            <a href="page/guest/nota.php">Nota</a>
          </li>
          <li>
            <a href="page/guest/profil.php">Profil</a>
          </li>
        </ul>
      </div>
